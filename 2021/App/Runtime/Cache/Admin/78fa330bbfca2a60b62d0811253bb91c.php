...
<script src="/2021/Public/Static/Admin/ueditor/ueditor.config.js"></script>
<script src="/2021/Public/Static/Admin/ueditor/ueditor.all.js"></script>
<style>
  #start_tip{
    display: none;
  }
                            ...
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" action="<?php echo U('StreetHistory/update');?>" method="post">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="address" name="address" type="text" value="<?php echo ($streetHistory['address']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="latitude" name="latitude" type="text" value="<?php echo ($streetHistory['latitude']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="longitude" name="longitude" type="text" value="<?php echo ($streetHistory['longitude']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                  ...
                                  <div class="form-group">
									...
									<div class="form-group filled">
                                        ...
                                        <div class="col-sm-8">
                                                <input class="form-control1" id="grade" name="grade" type="text" value="<?php echo ($streetHistory['grade']); ?>">
                                        </div>
...
<script type="text/javascript" src="/2021/Public/Static/Admin/js/dropzone.min.js"></script>
<script type="text/javascript">
    file_input = 'cover';
