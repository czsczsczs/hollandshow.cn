                                      ...
                                      <div class="col-md-6">
                                        <div class="row" id="imagesPanel">
                                          <?php if($images != null): if(is_array($images)): $i = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Row): $mod = ($i % 2 );++$i;?><div class="col-xs-3 col-md-4">
                                                ...
                                                <input type="hidden" name="photos[file_id][]" value="<?php echo ($Row['images_id']); ?>">
                                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
                                            <?php else: ?>
                                                <input type="hidden" name="photos" value=""><?php endif; ?>
                                        </div>
        ...
        Dropzone.options.dropzoneImg = {
            ...
            success: function (file, done) {
                ...
                if(done.code == 1){
                    ...
                    // /* 圖片id */
                    imageTxt += '<input type="hidden" name="photos[file_id][]" value="'+ done.file_id +'">';
                    imageTxt += "</div>";
