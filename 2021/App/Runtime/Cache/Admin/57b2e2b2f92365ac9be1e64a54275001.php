                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" action="<?php echo U('Shop/update');?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput">所屬類型*</label>
                                        <div class="col-sm-8">
                                           <select class="form-control select2" name="shoptype" ng-model="model.select" required="">
                                                ...
                                                <option name="shoptype" <?php if($shop['shoptype'] == 'discount'): ?>selected="selected"<?php endif; ?> value="discount">優惠</option>
                                                <option name="shoptype" <?php if($shop['shoptype'] == 'food'): ?>selected="selected"<?php endif; ?> value="food">美食</option>
                                                <option name="shoptype" <?php if($shop['shoptype'] == 'fashion'): ?>selected="selected"<?php endif; ?> value="fashion">潮店</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput">營業時間</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput">優惠活動</label>
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="special_offer" name="special_offer" type="text" value="<?php echo ($shop['special_offer']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
