                    ...
                    <div class="xs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" action="<?php echo U('Links/update');?>" method="post">
                                    <input type="hidden" name="id" value="<?php echo ($links['id']); ?>">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput">合作夥伴名稱</label>
                                        <div class="col-sm-6">
                                            <input class="form-control1" id="title" name="title" type="text" value="<?php echo ($links['title']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group filled">
                                        <label class="col-sm-2 control-label" for="focusedinput">跳轉url</label>
                                        <div class="col-sm-6">
                                                <input class="form-control1" id="url" name="url" type="text" value="<?php echo ($links['url']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-2">
                                          <div class="cover-box">
                                              <div class="c-box">
                                                <img src="<?php echo ($links["image"]); ?>">
                                              </div>
                                          </div>
                                          <input type="hidden" name="image" id="cover" value="<?php echo ($links["image"]); ?>">
                                          <div style="width: 250px;"><h5>建议上传163x51尺寸的图片！！！</h5></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            發佈&nbsp;&nbsp;<input name="status" type="radio" <?php if($links['status'] == 'published'): ?>checked="checked"<?php endif; ?> value="published">&nbsp;&nbsp;&nbsp;&nbsp;草稿&nbsp;&nbsp;<input name="status" <?php if($links['status'] == 'draft'): ?>checked="checked"<?php endif; ?>  type="radio" value="draft">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            是&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($links['recommend'] == 1): ?>checked="checked"<?php endif; ?> value="1">&nbsp;&nbsp;&nbsp;&nbsp;否&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($links['recommend'] == 0): ?>checked="checked"<?php endif; ?> value="0">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
