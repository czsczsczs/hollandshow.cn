                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                           <select class="form-control select2" name="shoptype" ng-model="model.select" required="">
                                                ...
                                                <option name="shoptype" selected="selected" value="discount">優惠</option>
                                                <option name="shoptype" selected="selected" value="food">美食</option>
                                                <option name="shoptype" selected="selected" value="fashion">潮店</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
