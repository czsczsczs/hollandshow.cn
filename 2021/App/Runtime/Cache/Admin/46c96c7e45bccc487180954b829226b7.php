        ...
        <div class="xs">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" action="<?php echo U('Media/update');?>" method="post">
                        <input type="hidden" name="id" value="<?php echo ($media['id']); ?>">
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="focusedinput">標題*</label>
                            <div class="col-sm-8">
                                <input class="form-control1" id="title" name="title" type="text" value="<?php echo ($media['title']); ?>">
                            </div>
                            <div class="col-sm-2">
                                <p class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control1" id="description" name="description" type="text" value="<?php echo ($media['description']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="focusedinput">資訊地址</label>
                            <div class="col-sm-8">
                                <input class="form-control1" id="url" name="url" type="text" value="<?php echo ($media['url']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="cover-box">
                                    <div class="c-box">
                                        <img src="<?php echo ($media["cover"]); ?>">
                                    </div>
                                </div>
                                <input type="hidden" name="cover" id="cover" value="<?php echo ($media["cover"]); ?>">
                                <h5>请上传图片尺寸为270x180的图片!!!</h5>
                            ...
                            <div class="col-md-6">
                                <div class="row" id="imagesPanel">
                                    <?php if($images != null): if(is_array($images)): $i = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Row): $mod = ($i % 2 );++$i;?><div class="col-xs-3 col-md-4">
                                                ...
                                                <div class="item">
                                                    <div style="display: table-cell;vertical-align: middle;text-align: center;width: 200px;height: 200px;overflow: hidden;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                發佈&nbsp;&nbsp;<input name="status" type="radio" <?php if($media['status'] == 'published'): ?>checked="checked"<?php endif; ?> value="published">&nbsp;&nbsp;&nbsp;&nbsp;草稿&nbsp;&nbsp;<input name="status" <?php if($media['status'] == 'draft'): ?>checked="checked"<?php endif; ?>  type="radio" value="draft">
                            </div>
                            <div class="col-sm-2">
                                <p class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                是&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($media['recommend'] == 1): ?>checked="checked"<?php endif; ?> value="1">&nbsp;&nbsp;&nbsp;&nbsp;否&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($media['recommend'] == 0): ?>checked="checked"<?php endif; ?> value="0">
                            </div>
                            <div class="col-sm-2">
                                <p class="help-block">
