...
<!--=== Footer ===-->
		<div class="container">
				<ul id="tag">
					<li style="background-color:#385A9F;"><a style="color: white;text-decoration:none;" href="<?php echo U('Media/index');?>">圖片集</a></li>
					<li><a style="color: #385A9F;text-decoration:none;" href="<?php echo U('Media2/index');?>">視頻集</a></li>
				</ul>
			<div class="row-fluid">
				<div id="w" class="span9">

					<ul class="portfolio recent-work clearfix newproimg">
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li data-id="id-1" class="street medialiwidth">
								<a href="<?php echo U('Media/detail',array('id'=>$row['id']));?>">
									<em class="overflow-hidden meindeximg"><img class="meinmg" src="<?php echo ($row['cover']); ?>" alt="" /></em>
...
<script type="text/javascript">
    //右下角分享地址
        var wz = "https://www.hollandshow.cn<?php echo U('Media/index');?>"       
</script>
