...
<div class="breadcrumbs margin-bottom-40">
    <div class="container">
        ...
        <ul class="pull-left breadcrumb newul">
            ...
            <li id="shangye" class="active" style="color: #555;"></li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
...
<div class="container">
    <div class="row-fluid">
        <div id="w">
            <div class="sort">
                <!-- 優惠 -->
                <ul class="unstyled inline" style="display:none;" id="q">
                    <!-- <li><a href="<?php echo U('Shop/index');?>" <?php if($street_id == ''): ?>class="selected"<?php endif; ?>>全部</a></li> 
                    <?php if(is_array($street)): $i = 0; $__LIST__ = $street;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$street_row): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Shop/categroy',array('street_id'=>$street_row['id']));?>" <?php if($street_id == $street_row['id']): ?>class="selected"<?php endif; ?>><?php echo ($street_row['name']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?> -->
                </ul>
                <ul class="unstyled inline" style="display:none;" id="a">
                    <!-- <li><a href="<?php echo U('Shop/index');?>" <?php if($street_id == ''): ?>class="selected"<?php endif; ?>>全部</a></li> 
                    <?php if(is_array($street)): $i = 0; $__LIST__ = $street;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$street_row): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Shop/categroy/shoptype/discount',array('street_id'=>$street_row['id']));?>" <?php if($street_id == $street_row['id']): ?>class="selected"<?php endif; ?>><?php echo ($street_row['name']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?> -->
                </ul>
                <!-- 美食 -->
                <ul class="unstyled inline" style="display:none;" id="b">
                    <!-- <li><a href="<?php echo U('Shop/index');?>" <?php if($street_id == ''): ?>class="selected"<?php endif; ?>>全部</a></li>
                    <?php if(is_array($street)): $i = 0; $__LIST__ = $street;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$street_row): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Shop/categroy/shoptype/food',array('street_id'=>$street_row['id']));?>" <?php if($street_id == $street_row['id']): ?>class="selected"<?php endif; ?>><?php echo ($street_row['name']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?> -->
                </ul>
                <!-- 潮店 -->
                <ul class="unstyled inline" style="display:none;" id="c">
                    <!-- <li><a href="<?php echo U('Shop/index');?>" <?php if($street_id == ''): ?>class="selected"<?php endif; ?>>全部</a></li>
                    <?php if(is_array($street)): $i = 0; $__LIST__ = $street;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$street_row): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Shop/categroy/shoptype/fashion',array('street_id'=>$street_row['id']));?>" <?php if($street_id == $street_row['id']): ?>class="selected"<?php endif; ?>><?php echo ($street_row['name']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?> -->
                </ul>

            </div>

            <ul class="portfolio recent-work clearfix shopwrapcen">
...
<script type="text/javascript"> 
 //右下角分享地址
 var wz = "https://www.hollandshow.cn<?php echo U('Shop/index');?>"       
// 判断网址包含哪种类型
