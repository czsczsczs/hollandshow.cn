...
/* 跟其他模块显示模糊程度不一样，加这个单独对他缩小， */
@media screen and (max-width: 434px){
    .newindepod .thumbnail-img .thumb-img {
    max-width: 120% !important;
}
}
...
<div class="breadcrumbs margin-bottom-40">
	<div class="container">
        ...
        <ul class="pull-left breadcrumb newul">
            ...
            <li class="active" style="color: #555;">特色景點</li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
                        ...
                        <div style="width: 60%;float:right;overflow: hidden;margin: 0 10px;">
                            <h3 style="text-align-last: left;margin: 0;" id="index_overflow"
                                ...
                                <a style="color: #385A9F;" class="hover-effect txtstyle"
                                    href="<?php echo U('Posts/detail',array('id'=>$row['id']));?>"><?php echo ($row['title']); ?></a>
                            </h3>
                            ...
                            <p class="ppp" id="index_overflow"><a style="text-decoration:none;" class="pull-right"
                                    href="<?php echo U('Posts/detail',array('id'=>$row['id']));?>"><img
...
<script type="text/javascript">
    //右下角分享地址
        var wz = "https://www.hollandshow.cn<?php echo U('Posts/index');?>"       
</script>
<!--=== Footer ===-->
