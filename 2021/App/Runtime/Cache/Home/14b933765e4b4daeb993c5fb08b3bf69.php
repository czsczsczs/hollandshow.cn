...
<div class="breadcrumbs margin-bottom-20">
	<div class="container">
		...
		<ul class="pull-left breadcrumb newul">
			...
			<li class="active" style="color: #555;"><?php echo ($post['title']); ?></li>
		</ul>
	</div>
	<!--/container-->
</div>
		...
		<div class="span9">
			...
			<ul class="unstyled" style="font-size: 16px;">
				<li>
					...
					<span style="width: 200px;display: inline-block;vertical-align: top;"><?php echo ($post['business_hours']); ?></span>
				</li>
				<li>
					<span style="width:110px;display: inline-block;vertical-align: top;"><i class="icon-map-marker color-green"></i>
						具體地址：</span>
					<span style="width: 200px;display: inline-block;vertical-align: top;"><?php echo ($post['address']); ?></span>
				</li>
			</ul>
...
<script type="text/javascript">
	...
	var map = new qq.maps.Map(document.getElementById("allmap"), {
		center: new qq.maps.LatLng(<?php echo ($post['latitude']); ?>,<?php echo ($post['longitude']); ?>),      // 地图的中心地理坐标。
		zoom: 30                                                // 地图的中心地理坐标。
	});
	...
	var marker = new qq.maps.Marker({
		map: map,
		position: new qq.maps.LatLng(<?php echo ($post['latitude']); ?>,<?php echo ($post['longitude']); ?>)
	});
	marker.setIcon(icon);
...
<div class="container">
    <div class="index-activity " style="margin-bottom: -10px;">
        ...
        <div class="headline headlinetext">
            <h3><a href="javascript:volid(0)">合作夥伴</a></h3>
        </div>
        <div class="row-fluid">
            <div id="w">
    
                <ul class="portfolio clearfix" id="por">
    ...
    <div class="footer1">
        ...
        <!-- <img src="/2021/Public/Static/Home/img/footer/wechat.png" class="footer-share-wechat">
        <img src="/2021/Public/Static/Home/img/footer/icon_weibo_24.png" class="footer-share-weibo">
        <img src="/2021/Public/Static/Home/img/footer/facebook.png" class="footer-share-facebook"> -->
        <a style="color: #696969;text-decoration:underline;position: relative;top:-20px;" href="http://www.macautech.net/">普及科技（澳門）有限公司</a><span
         style="color: #696969;position: relative;top:-20px;">提供技術支持
