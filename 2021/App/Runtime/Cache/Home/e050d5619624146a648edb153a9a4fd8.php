...
<style>
  ...
  .newindepod .thumbnail-img .ppp img{
	  height: auto;
  }
  .newindepod .thumbnail-img .ppp{
	  margin: 0;
  }
  .newindepod .thumbnail-img .ppp a{
	  text-align: right;
  }
  .newindepod .thumbnail-img .ppp a:hover{
	  color: #385A9F;
  }
  .newindepod .thumbnail-img h3{
	overflow: hidden;
...
<div class="breadcrumbs margin-bottom-40">
	<div class="container">
		...
		<ul class="pull-left breadcrumb newul">
			...
			<li class="active" style="color: #555;">新聞資訊</li>
		</ul>
	</div>
	<!--/container-->
</div>
			...
			<div class="row-fluid">
				...
				<div class="span9" id="w">
					<ul class="portfolio recent-work clearfix thumb newindepod">
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li data-id="id-1" class=" street<?php echo ($row['street_id']); ?>" link="<?php echo U('News/detail',array('id'=>$row['id']));?>">
								...
								<span class="newimgborder"> 
									...
									<div style="width: 60%;float:right;overflow: hidden;margin: 0 10px;">
										<h3 style="text-align-last: left;margin: 0;" id="index_overflow" title="<?php echo ($row['title']); ?>">
										...
										<p class="ppp" id="index_overflow"><a style="text-decoration:none;" class="pull-right" href="<?php echo U('News/detail',array('id'=>$row['id']));?>"><img style="max-width: 25px;" src="/Public/Static/Home/img/eye.png">查看詳情</a></p>
									</div>
									</div>
...
<div class="span3">
	...
	<script type="text/javascript">
//右下角分享地址
	var wz = "https://www.hollandshow.cn<?php echo U('News/index');?>"
