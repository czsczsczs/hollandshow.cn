...
<div class="breadcrumbs margin-bottom-20">
	<div class="container">
		...
		<ul class="pull-left breadcrumb newul">
			...
			<li style="color: #777;">社區商業 <span class="divider">/</span></li>
			<li id="shangye" class="active" style="color: #555;"><?php echo ($shop['title']); ?></li>
		</ul>
	</div>
	<!--/container-->
</div>
		...
		<div class="span9">
			<div style="height: 100%;">
				<div id="myCarousel" class="carousel slide">
					<div id="imgcount" class="carousel-inner cent">
					 ...
					 <!--点击切换的大图片-->
					 <div id="shopbigimg" class="bigimgs" style="display: none;">
                        <img id="bigimg"/>
                    </div>
					<div id="shopsmallimg"  class="carousel-inner swiper-container swiper-con-newactivity" style="display: none;">
                        <ul class="swiper-wrapper ulc smallimg" style="height: auto;margin: 0;">
                            <?php if(is_array($images)): $key = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row2): $mod = ($key % 2 );++$key;?><li class="swiper-slide" link="javascript:void(0)">
                                    <div class="thumbnail-style imgthumb">
                                        <div class="thumbnail-img">
                                            <img style="width: 100%;" src="<?php echo ($row2['savepath']); ?>" alt="" />
                                        </div>
                                    </div>
                                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                        <div class="swiper-button-prev btnprev"><i class="icon-angle-left"></i></div>
                        <div class="swiper-button-next btnnext"><i class="icon-angle-right"></i></div>
                    </div>

					<div class="carousel-arrow" id="prevnext">
			...
			<div>
				<h3 style="color: #385A9F;"><?php echo ($shop['title']); ?></h3>
				<p><?php echo (htmlspecialchars_decode($shop['content'])); ?></p>

				<ul class="unstyled" style="font-size: 16px;">
					<li id="business">
						<span style="width:80px;vertical-align: top;color: #385A9F;">
							<!-- <img src="/2021/Public/Static/Home/img/opentime.png"/ style="width: 20px;">  -->
							營業時間</span>：
						<span id="business_hours" style="display: inline-block;vertical-align: top;"><?php echo ($shop['business_hours']); ?></span>
					</li>
					<li>
						<span style="width:80px;letter-spacing: 2em;margin-right:-2em;vertical-align: top;color: #385A9F;">
							<!-- <i class="icon-phone color-green"></i>  -->
							電話</span>：
						<span style="width:210px;display: inline-block;vertical-align: top;"><?php echo ($shop['phone']); ?></span>
					</li>
					<li>
						<span style="width:80px;letter-spacing: 2em;margin-right:-2em;vertical-align: top;color: #385A9F;">
							<!-- <i class="icon-map-marker color-green"></i> -->
							地點</span>：
						<span class="addrst" style="display: inline-block;vertical-align: top;"><?php echo ($shop['address']); ?></span>
					</li>
					<li id="none">
						<span style="width:80px;letter-spacing: 2em;margin-right:-2em;vertical-align: top;color: #385A9F;">
							<!-- <img src="/2021/Public/Static/Home/img/yh.png"/ style="width: 20px;"> -->
							優惠</span>：
						<span id="non" style="display: inline-block;vertical-align: top;"><?php echo ($shop['special_offer']); ?></span>
					</li>
				</ul>
			</div>
...
<script type="text/javascript">
	window.onload=function (){
		if ('<?php echo ($shop['special_offer']); ?>'!=''){
			document.getElementById('non').innerHTML='<?php echo ($shop['special_offer']); ?>';
		}else {
			document.getElementById('none').style.display='none';
		}
		if ('<?php echo ($shop['business_hours']); ?>'!=''){
			document.getElementById('business_hours').innerHTML='<?php echo ($shop['business_hours']); ?>';
		}else {
			document.getElementById('business').style.display='none';
		}
		if ('<?php echo ($shop['special_offer']); ?>'!=''){
			document.getElementById('special_offer').innerHTML='<?php echo ($shop['special_offer']); ?>';
		}else {
			document.getElementById('none').style.display='none';
		}
	}
...
<script type="text/javascript">
    ...
    if(url.indexOf('discount')>= 0){
        document.getElementById("shangye").innerText="優惠";
    }else if(url.indexOf('food')>= 0){
        document.getElementById("shangye").innerText="美食";
    }else if(url.indexOf('fashion')>= 0){
        document.getElementById("shangye").innerText="潮店";
    }
</script>
<script type="text/javascript">
    var photo=document.getElementById("imgcount");
    var count=photo.getElementsByTagName('img');
    if(count.length>4){
        document.getElementById('imgcount').style.display='none';
        document.getElementById('prevnext').style.display='none';
        document.getElementById('shopbigimg').style.display='block';
        document.getElementById('shopsmallimg').style.display='block';
    }
...
<script type="text/javascript">
   $(document).ready(function (){
       //点击小图切换大图
       $(".smallimg li img").hover(function() {
           $(".smallimg li img").click(function () {
               //获取图片的src属性
               var src = $(this).attr("src");
               //把点击的src属性的图片放在大图（id）的位置
               $('#bigimg').attr({src: src});
           });
       });
   });
