...
<div class="breadcrumbs margin-bottom-20">
	<div class="container">
		...
		<ul class="pull-left breadcrumb newul">
			...
			<li class="active" style="color: #555;"><?php echo ($media['title']); ?></li>
		</ul>
	</div>
	<!--/container-->
</div>
		...
		<div class="span9">
			...
			<div class="row-fluid">
				<div id="w">
					...
					<ul class="portfolio recent-work clearfix mleft">
						<?php if(is_array($images)): $i = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Row): $mod = ($i % 2 );++$i;?><li data-id="id-1" class="street<?php echo ($Row['street_id']); ?>">
								<a href="#">
									<em class="overflow-hidden imgs">
										<img style="width: auto;height: auto" onclick="expandPhoto(this);" src="<?php echo ($Row['savepath']); ?>" alt="" />
									</em>
								</a>
