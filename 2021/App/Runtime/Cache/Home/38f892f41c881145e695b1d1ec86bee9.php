...
<div class="breadcrumbs margin-bottom-20">
	<div class="container">
		<!-- <h1 class=" pull-left color-green "></h1> -->
		<ul class="pull-left breadcrumb newul">
			...
			<li class="active" style="color: #555;"><?php echo ($news['title']); ?></li>
		</ul>
	</div>
	<!--/container-->
</div>
...
<div class="container">
	<div class="row-fluid blog-page portflio_details">
		...
		<div class="span9">
			...
			<div class="tab-content margin-bottom-20" style="border: none;">
			...
			<!--/tab-content-->
			<!--<div class="line_02" style="margin-top: 25px;margin-bottom: 30px;">
