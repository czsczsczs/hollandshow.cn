...
<style>
   ...
   .row-fluid .activity .span3{
       ...
       .thumbnails{
        ...
        .thumbnail-kenburn .thumbnail-img img{
            width: 110%;
        ...
        .activemodel{
            ...
            position: relative;
            background: white;
            box-shadow: 3px 3px 5px #8888886b;
        }
...
<div class="breadcrumbs margin-bottom-40">
	<div class="container" >
        ...
        <ul class="pull-left breadcrumb newul">
            ...
            <li class="<?php echo U('Active/index');?>">巡禮活動</li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
            ...
            <ul class="thumbnails activity ulc">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li class="span3" link="<?php echo U('Active/detail',array('id'=>$row['id']));?>" >
            		<div class="thumbnail-style thumbnail-kenburn">
                        ...
                        <?php if($row['time']): ?><p style="color: #385A9F;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">活動時間：</p>
                        <p ><?php echo ($row['time']); ?></p>
                        <?php else: ?>
                        <p>活動時間:無</p><?php endif; ?>
            			<p style="color: #385A9F;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">活動地點：</p>
...
<!--=== End Content Part ===-->
<script type="text/javascript">
	var wz = "https://www.hollandshow.cn<?php echo U('Active/index');?>"
