...
<div class="breadcrumbs margin-bottom-20">
	<div class="container">
		...
		<ul class="pull-right breadcrumb">
			...
			<li><a href="<?php echo U('News/index');?>">媒體報道</a> <span class="divider">/</span></li>
	...
	<div class="row-fluid blog-page portflio_details">
		...
		<div class="span9">
			...
			<div class="headdiv">
				...
				<span>相關資訊：
					<?php if($posts['title'] != NULL): ?><a href="<?php echo U('Posts/detail',array('id'=>$posts['id']));?>"><?php echo ($posts['title']); ?></a>
						<?php else: ?>
						<a class="no">無</a><?php endif; ?>
				</span>
			</div>
...
<script type="text/javascript">
	//分享二维码
	var wz = "https://www.hollandshow.cn/News/detail/id/<?php echo ($news['id']); ?>.html"
