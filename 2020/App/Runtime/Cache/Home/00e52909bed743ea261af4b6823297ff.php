...
<div class="fullwidthbanner-container">
	<div class="fullwidthabnner">
		<ul>
			<?php if(is_array($slide)): $i = 0; $__LIST__ = $slide;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$slide_row): $mod = ($i % 2 );++$i;?><li data-transition="slideleft" data-slotamount="1" data-masterspeed="300" data-thumb="/2020/Public/Static/Home/img/sliders/revolution/thumbs/thumb1.jpg">
					<a href="<?php echo ($slide_row['url']); ?>" target="_blank">
						<img src="<?php echo ($slide_row['image']); ?>" alt="" style="object-fit: contain;" />
...
<div class="container">
	...
	<!--/thumbnails-->
	<!-- //End Recent Works -->
	<div class="index-activity" style="display:none;">
		<div class="headline">
			<h3><a href="https://www.hollandshow.cn/Active/index.html">活動花絮</a></h3>
		</div>
		<div class="swiper-container swiper-con-activity">
			<ul class="thumbnails swiper-wrapper ulc">
				<?php if(is_array($active)): $i = 0; $__LIST__ = $active;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$active_row): $mod = ($i % 2 );++$i;?><li class="swiper-slide">
						<div class="thumbnail-style" style="height: 335px;">
							<div class="thumbnail-img">
								<div class="overflow-hidden imgsize">
									<img src="<?php echo ($active_row['cover_width_300']); ?>" alt=""/>
			...
			<ul class="thumbnails swiper-wrapper ulc">
				<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><li class="swiper-slide" link="<?php echo U('News/detail',array('id'=>$new['id']));?>">
						<div class="thumbnail-style">
							<div class="thumbnail-img">
								<div class="overflow-hidden imgsize">
									<img style="" src="<?php echo ($new['cover_width_300']); ?>" alt="" / style="height:100%;">
								</div>
			...
			<ul class="thumbnails swiper-wrapper ulc">
				<?php if(is_array($post)): $i = 0; $__LIST__ = $post;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p_row): $mod = ($i % 2 );++$i;?><li class="swiper-slide" link="<?php echo U('Posts/detail',array('id'=>$p_row['id']));?>">
						<div class="thumbnail-style">
							<div class="thumbnail-img">
								<div class="overflow-hidden imgsize">
									<img style="" src="<?php echo ($p_row['cover_width_300']); ?>" alt="" />
								</div>
								<a class="btn-more hover-effect" href="<?php echo U('Posts/detail',array('id'=>$p_row['id']));?>">查看詳情+</a>
							</div>
							<!-- <span>
			...
			<ul class="thumbnails swiper-wrapper ulc">
				<?php if(is_array($shop)): $i = 0; $__LIST__ = $shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s_row): $mod = ($i % 2 );++$i;?><li class="swiper-slide" link="<?php echo U('Shop/detail',array('id'=>$s_row['id']));?>">
						<div class="thumbnail-style">
							<div class="thumbnail-img">
								<div class="overflow-hidden imgsize">
									<img style="" src="<?php echo ($s_row['cover_width_300']); ?>" alt="" />
								</div>
								<a class="btn-more hover-effect" href="<?php echo U('Shop/detail',array('id'=>$s_row['id']));?>">查看詳情+</a>
							</div>							<!-- <span>
...
<script type="text/javascript">
	var wz = "https://www.hollandshow.cn/Index/index.html"
